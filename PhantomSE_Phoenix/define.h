...
#define USE_PHOENIX_COMMANDER
//------------------------------------------------
#ifdef USE_PHOENIX_SE
  #define USER_PIN           2
  //#define DISABLE_WIFI
  #ifdef USE_PHOENIX_COMMANDER
    #undef USE_PHOENIX_COMMANDER
  #endif
#else
...
#endif
#ifdef USE_PHOENIX_COMMANDER
  #define PhoenixHost        "192.168.202.170"
  #define PhoenixPort         123
#else
#define PhoenixCMD_setup(...)
#define PhoenixCMD_loop(...)
#endif
//================================================================================//
//#define USE_USB
//------------------------------------------------
