...
//--------------------------------------------------------------------
//[Arbotix Pin Numbers]
#define USER          USER_PIN // defaults to 13 but Arbotix on 0...
...
#define cLFCoxaPin      15    // Front Left leg Hip Horizontal
#define cLFFemurPin     16    // Front Left leg Hip Vertical
#define cLFTibiaPin     17    // Front Left leg Knee

#define cTurretRotPin   18    // Turret Rotate Pin
#define cTurretTiltPin  19    // Turret Tilt pin

//--------------------------------------------------------------------
//[MIN/MAX ANGLES] - Start off assume same as Phoenix... [value is degress*10]
