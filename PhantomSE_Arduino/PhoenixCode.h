...
static const short cTibiaHornOffset1[] PROGMEM = { cRRTibiaHornOffset1, cRMTibiaHornOffset1, cRFTibiaHornOffset1, cLRTibiaHornOffset1, cLMTibiaHornOffset1, cLFTibiaHornOffset1};
...
// Servo Horn offsets
#ifdef cRRFemurHornOffset1   // per leg configuration
static const short cFemurHornOffset1[] PROGMEM = { cRRFemurHornOffset1, cRMRFemurHornOffset1, cRMFFemurHornOffset1, cRFFemurHornOffset1, cLRFemurHornOffset1, cLMRFemurHornOffset1, cLMFFemurHornOffset1, cLFFemurHornOffset1};
#define CFEMURHORNOFFSET1(LEGI) ((short)pgm_read_word(&cFemurHornOffset1[LEGI]))
#else   // Fixed per leg, if not defined 0
#ifndef cFemurHornOffset1
#define cFemurHornOffset1  0
...
#ifdef cRRTibiaHornOffset1   // per leg configuration
static const short cTibiaHornOffset1[] PROGMEM = { cRRTibiaHornOffset1, cRMRTibiaHornOffset1, cRMFTibiaHornOffset1, cRFTibiaHornOffset1, cLRTibiaHornOffset1, cLMRTibiaHornOffset1, cLMFTibiaHornOffset1, cLFTibiaHornOffset1};
#define CTIBIAHORNOFFSET1(LEGI) ((short)pgm_read_word(&cTibiaHornOffset1[LEGI]))
#else   // Fixed per leg, if not defined 0
#ifndef cTibiaHornOffset1
#define cTibiaHornOffset1  0
...
#ifdef c4DOF
#ifdef cRRTarsHornOffset1   // per leg configuration
static const short cTarsHornOffset1[] PROGMEM = { cRRTarsHornOffset1,  cRMRTarsHornOffset1,  cRMFTarsHornOffset1,  cRFTarsHornOffset1,  cLRTarsHornOffset1,  cLMRTarsHornOffset1,  cLMFTarsHornOffset1,  cLFTarsHornOffset1};
#define CTARSHORNOFFSET1(LEGI) ((short)pgm_read_word(&cTarsHornOffset1[LEGI]))
#else   // Fixed per leg, if not defined 0
#ifndef cTarsHornOffset1
#define cTarsHornOffset1  0
...
//Min / Max values
#ifndef SERVOS_DO_MINMAX
const short cCoxaMin1[]  PROGMEM = { cRRCoxaMin1,  cRMRCoxaMin1,  cRMFCoxaMin1,  cRFCoxaMin1,  cLRCoxaMin1,  cLMRCoxaMin1,   cLMFCoxaMin1,  cLFCoxaMin1};
const short cCoxaMax1[]  PROGMEM = { cRRCoxaMax1,  cRMRCoxaMax1,  cRMFCoxaMax1,  cRFCoxaMax1,  cLRCoxaMax1,  cLMRCoxaMax1,   cLMFCoxaMax1,  cLFCoxaMax1};
const short cFemurMin1[] PROGMEM = { cRRFemurMin1, cRMRFemurMin1, cRMFFemurMin1, cRFFemurMin1, cLRFemurMin1, cLMRFemurMin1,  cLMFFemurMin1, cLFFemurMin1};
const short cFemurMax1[] PROGMEM = { cRRFemurMax1, cRMRFemurMax1, cRMFFemurMax1, cRFFemurMax1, cLRFemurMax1, cLMRFemurMax1,  cLMFFemurMax1, cLFFemurMax1};
const short cTibiaMin1[] PROGMEM = { cRRTibiaMin1, cRMRTibiaMin1, cRMFTibiaMin1, cRFTibiaMin1, cLRTibiaMin1, cLMRTibiaMin1,  cLMFTibiaMin1, cLFTibiaMin1};
const short cTibiaMax1[] PROGMEM = { cRRTibiaMax1, cRMRTibiaMax1, cRMFTibiaMax1, cRFTibiaMax1, cLRTibiaMax1, cLMRTibiaMax1,  cLMFTibiaMax1, cLFTibiaMax1};

#ifdef c4DOF
const short cTarsMin1[] PROGMEM = { cRRTarsMin1, cRMRTarsMin1, cRMFTarsMin1, cRFTarsMin1, cLRTarsMin1, cLMRTarsMin1, cLMFTarsMin1, cLFTarsMin1};
const short cTarsMax1[] PROGMEM = { cRRTarsMax1, cRMRTarsMax1, cRMFTarsMax1, cRFTarsMax1, cLRTarsMax1, cLMRTarsMax1, cLMFTarsMax1, cLFTarsMax1};
#endif
#endif
...
//Leg Lengths
const byte cCoxaLength[]  PROGMEM = { cRRCoxaLength,  cRMRCoxaLength, cRMFCoxaLength,  cRFCoxaLength,  cLRCoxaLength,  cLMRCoxaLength, cLMFCoxaLength,  cLFCoxaLength};
const byte cFemurLength[] PROGMEM = { cRRFemurLength, cRMRFemurLength, cRMFFemurLength, cRFFemurLength, cLRFemurLength, cLMRFemurLength, cLMFFemurLength, cLFFemurLength};
const byte cTibiaLength[] PROGMEM = { cRRTibiaLength, cRMRTibiaLength, cRMFTibiaLength, cRFTibiaLength, cLRTibiaLength, cLMRTibiaLength, cLMFTibiaLength, cLFTibiaLength};
#ifdef c4DOF
const byte cTarsLength[]  PROGMEM = { cRRTarsLength, cRMRTarsLength, cRMFTarsLength, cRFTarsLength, cLRTarsLength, cLMRTarsLength, cLMFTarsLength, cLFTarsLength};
#endif

//Body Offsets [distance between the center of the body and the center of the coxa]
const short cOffsetX[] PROGMEM = { cRROffsetX, cRMROffsetX, cRMFOffsetX, cRFOffsetX, cLROffsetX, cLMROffsetX, cLMFOffsetX, cLFOffsetX};
const short cOffsetZ[] PROGMEM = { cRROffsetZ, cRMROffsetZ, cRMFOffsetZ, cRFOffsetZ, cLROffsetZ, cLMROffsetZ, cLMFOffsetZ, cLFOffsetZ};

//Default leg angle
const short cCoxaAngle1[] PROGMEM = { cRRCoxaAngle1, cRMRCoxaAngle1, cRMFCoxaAngle1, cRFCoxaAngle1, cLRCoxaAngle1, cLMRCoxaAngle1, cLMFCoxaAngle1, cLFCoxaAngle1};

#ifdef cRRInitCoxaAngle1    // We can set different angles for the legs than just where they servo horns are set...
const short cCoxaInitAngle1[] PROGMEM = { cRRInitCoxaAngle1, cRMRInitCoxaAngle1, cRMFInitCoxaAngle1, cRFInitCoxaAngle1, cLRInitCoxaAngle1, cLMRInitCoxaAngle1, cLMFInitCoxaAngle1, cLFInitCoxaAngle1};
#endif

//Start positions for the leg
const short cInitPosX[] PROGMEM = { cRRInitPosX, cRMRInitPosX, cRMFInitPosX, cRFInitPosX, cLRInitPosX, cLMRInitPosX, cLMFInitPosX, cLFInitPosX};
const short cInitPosY[] PROGMEM = { cRRInitPosY, cRMRInitPosY, cRMFInitPosY, cRFInitPosY, cLRInitPosY, cLMRInitPosY, cLMFInitPosY, cLFInitPosY};
const short cInitPosZ[] PROGMEM = { cRRInitPosZ, cRMRInitPosZ, cRMFInitPosZ, cRFInitPosZ, cLRInitPosZ, cLMRInitPosZ, cLMFInitPosZ, cLFInitPosZ};
...
//Min / Max values
#ifndef SERVOS_DO_MINMAX
const short cCoxaMin1[]  PROGMEM = { cRRCoxaMin1,  cRFCoxaMin1,  cLRCoxaMin1,  cLFCoxaMin1};
const short cCoxaMax1[]  PROGMEM = { cRRCoxaMax1,  cRFCoxaMax1,  cLRCoxaMax1,  cLFCoxaMax1};
const short cFemurMin1[] PROGMEM = { cRRFemurMin1, cRFFemurMin1, cLRFemurMin1, cLFFemurMin1};
const short cFemurMax1[] PROGMEM = { cRRFemurMax1, cRFFemurMax1, cLRFemurMax1, cLFFemurMax1};
const short cTibiaMin1[] PROGMEM = { cRRTibiaMin1, cRFTibiaMin1, cLRTibiaMin1, cLFTibiaMin1};
const short cTibiaMax1[] PROGMEM = { cRRTibiaMax1, cRFTibiaMax1, cLRTibiaMax1, cLFTibiaMax1};
#ifdef c4DOF
const short cTarsMin1[] PROGMEM = { cRRTarsMin1, cRFTarsMin1, cLRTarsMin1, cLFTarsMin1};
const short cTarsMax1[] PROGMEM = { cRRTarsMax1, cRFTarsMax1, cLRTarsMax1, cLFTarsMax1};
#endif
#endif
...
#ifdef c4DOF
const boolean cTarsInv[] = { cRRTarsInv, cRFTarsInv, cLRTarsInv, cLFTarsInv};
#endif

//Leg Lengths
const byte cCoxaLength[]  PROGMEM = { cRRCoxaLength,  cRFCoxaLength,  cLRCoxaLength,  cLFCoxaLength};
const byte cFemurLength[] PROGMEM = { cRRFemurLength, cRFFemurLength, cLRFemurLength, cLFFemurLength};
const byte cTibiaLength[] PROGMEM = { cRRTibiaLength, cRFTibiaLength, cLRTibiaLength, cLFTibiaLength};
#ifdef c4DOF
const byte cTarsLength[]  PROGMEM = { cRRTarsLength, cRFTarsLength, cLRTarsLength, cLFTarsLength};
#endif

//Body Offsets [distance between the center of the body and the center of the coxa]
const short cOffsetX[] PROGMEM = { cRROffsetX, cRFOffsetX, cLROffsetX, cLFOffsetX};
const short cOffsetZ[] PROGMEM = { cRROffsetZ, cRFOffsetZ, cLROffsetZ, cLFOffsetZ};

//Default leg angle
const short cCoxaAngle1[] PROGMEM = { cRRCoxaAngle1, cRFCoxaAngle1, cLRCoxaAngle1, cLFCoxaAngle1};

#ifdef cRRInitCoxaAngle1    // We can set different angles for the legs than just where they servo horns are set...
const short cCoxaInitAngle1[] PROGMEM = { cRRInitCoxaAngle1, cRFInitCoxaAngle1, cLRInitCoxaAngle1, cLFInitCoxaAngle1};
#endif

//Start positions for the leg
const short cInitPosX[] PROGMEM = { cRRInitPosX, cRFInitPosX, cLRInitPosX, cLFInitPosX};
const short cInitPosY[] PROGMEM = { cRRInitPosY, cRFInitPosY, cLRInitPosY, cLFInitPosY};
const short cInitPosZ[] PROGMEM = { cRRInitPosZ, cRFInitPosZ, cLRInitPosZ, cLFInitPosZ};
...
//  uint32_t _LegPosYcRF = (short)pgm_read_word(&cInitPosY[cRF]);
//  uint32_t _LegPosYcRR = (short)pgm_read_word(&cInitPosY[cRR]);
//  uint32_t _LegPosYcLR = (short)pgm_read_word(&cInitPosY[cLR]);
//  #ifdef HEXMODE
//  uint32_t _LegPosYcRM = (short)pgm_read_word(&cInitPosY[cRM]);
//  uint32_t _LegPosYcLM = (short)pgm_read_word(&cInitPosY[cLM]);
//  #elif defined(OCTOMODE)
//  uint32_t _LegPosYcRMR = (short)pgm_read_word(&cInitPosY[cRMR]);
//  uint32_t _LegPosYcRMF = (short)pgm_read_word(&cInitPosY[cRMF]);
//  uint32_t _LegPosYcLMR = (short)pgm_read_word(&cInitPosY[cLMR]);
//  uint32_t _LegPosYcLMF = (short)pgm_read_word(&cInitPosY[cLMF]);
//  #endif
//  uint32_t _LegPosYcLF = (short)pgm_read_word(&cInitPosY[cLF]);
//  yield();
//
//  if(_LegPosYcRF==LegPosY[cRF]) _LegPosYcRF = 1; else _LegPosYcRF = 0;
//  if(_LegPosYcRR==LegPosY[cRF]) _LegPosYcRR = 1; else _LegPosYcRR = 0;
//  if(_LegPosYcLR==LegPosY[cRF]) _LegPosYcLR = 1; else _LegPosYcLR = 0;
//  #ifdef HEXMODE
//  if(_LegPosYcRM==LegPosY[cRF]) _LegPosYcRM = 1; else _LegPosYcRM = 0;
//  if(_LegPosYcLM==LegPosY[cRF]) _LegPosYcLM = 1; else _LegPosYcLM = 0;
//  #elif defined(OCTOMODE)
//  if(_LegPosYcRMR==LegPosY[cRF]) _LegPosYcRMR = 1; else _LegPosYcRMR = 0;
//  if(_LegPosYcRMF==LegPosY[cRF]) _LegPosYcRMF = 1; else _LegPosYcRMF = 0;
//  if(_LegPosYcLMR==LegPosY[cRF]) _LegPosYcLMR = 1; else _LegPosYcLMR = 0;
//  if(_LegPosYcLMF==LegPosY[cRF]) _LegPosYcLMF = 1; else _LegPosYcLMF = 0;
//  #endif
//  if(_LegPosYcLF==LegPosY[cRF]) _LegPosYcLF = 1; else _LegPosYcLF = 0;
//  yield();
//  //printlnDebug("[TEST] 7:12");
//
//  if  (
//      _LegPosYcRF && _LegPosYcRR && _LegPosYcLR &&
//      #ifdef HEXMODE
//      _LegPosYcRM && _LegPosYcLM &&
//      #elif defined(OCTOMODE)
//      _LegPosYcRMR && _LegPosYcRMF && _LegPosYcLMR && _LegPosYcLMF &&
//      #endif
//      _LegPosYcLF
//      ) AllDown = true;
//   else AllDown = false;
  ...
  if (g_InControlState.SelectedLeg <= (CNT_LEGS-1)) {
    ...
    if (g_InControlState.PrevSelectedLeg!=255) g_InControlState.PrevSelectedLeg = 255;
  }
  #endif
}

void GaitSelect(void) { // Gait selector
  // First pass simply use defined table, next up will allow robots to add or relace set...
  if (g_InControlState.GaitType < NUM_GAITS) {
    #ifdef ADD_GAITS
    if (g_InControlState.GaitType < (sizeof(APG_EXTRA)/sizeof(APG_EXTRA[0]))) g_InControlState.gaitCur = APG_EXTRA[g_InControlState.GaitType];
    else g_InControlState.gaitCur = APG[g_InControlState.GaitType - (sizeof(APG_EXTRA)/sizeof(APG_EXTRA[0]))];
    #else
...
void GaitSeq(void) {
  ...
  if (fWalking || (g_InControlState.ForceGaitStepCnt != 0)) TravelRequest = true;   // Is walking or was walking...
  else {
    ...
    if (TravelRequest) {
        ...
        if (g_InControlState.TravelLength.z < 0) g_InControlState.GaitStep = ((g_InControlState.TravelLength.X < 0)? g_InControlState.gaitCur.GaitLegNr[cLR] : g_InControlState.gaitCur.GaitLegNr[cRR]);
        else g_InControlState.GaitStep = ((g_InControlState.TravelLength.X < 0)? g_InControlState.gaitCur.GaitLegNr[cLF] : g_InControlState.gaitCur.GaitLegNr[cRF]);
  ...
  if (g_InControlState.GaitStep>g_InControlState.gaitCur.StepsInGait) g_InControlState.GaitStep = 1;
...
void BalanceBody(void) {
  ...
  if (g_InControlState.gaitCur.COGAngleStep1 == 0) {  // In Quad mode only do those for those who don't support COG Balance...
    ...
    if (TotalYBal1 > 0) TotalYBal1 -=  1800;    // Rotate balance circle by +/- 180 deg
    else TotalYBal1 += 1800;
    #endif        

    if (TotalZBal1 < -1800) TotalZBal1 += 3600;    //Compensate for extreme balance positions that causes overflow
    if (TotalXBal1 < -1800) TotalXBal1 += 3600;   //Compensate for extreme balance positions that causes overflow
    ...
    // Quad mode with COG balance mode...
      ...
      if (COGShiftNeeded) {
        if (g_InControlState.gaitCur.COGCCW) COGAngle1 = g_InControlState.gaitCur.COGAngleStart1 - (g_InControlState.GaitStep-1) * g_InControlState.gaitCur.COGAngleStep1;
        else COGAngle1 = g_InControlState.gaitCur.COGAngleStart1 + (g_InControlState.GaitStep-1) * g_InControlState.gaitCur.COGAngleStep1;
...
void GetSinCos(short AngleDeg1) {
  ...
  if (AngleDeg1 < 0) ABSAngleDeg1 = AngleDeg1 *-1;
  else ABSAngleDeg1 = AngleDeg1;
  
  //Shift rotation to a full circle of 360 deg -> AngleDeg // 360
  if (AngleDeg1 < 0) AngleDeg1 = 3600-(ABSAngleDeg1-(3600*(ABSAngleDeg1/3600)));    //Negative values
  else AngleDeg1 = ABSAngleDeg1-(3600*(ABSAngleDeg1/3600));               //Positive values
...
short GetATan2 (short AtanX, short AtanY) {
  ...
  if (AtanY < 0) Atan4 = -AngleRad4;  // removed overhead... Atan4 = AngleRad4 * (AtanY/abs(AtanY));  
  else Atan4 = AngleRad4;
  return Atan4;
}    
...
void BodyFK (short PosX, short PosZ, short PosY, short RotationY, byte BodyIKLeg) {
  ...
  if (g_fRobotUpsideDown) GetSinCos (-g_InControlState.BodyRot1.y+(-RotationY*c1DEC)+TotalYBal1) ;
  else GetSinCos (g_InControlState.BodyRot1.y+(RotationY*c1DEC)+TotalYBal1) ;
  #else
...
void LegIK (short IKFeetPosX, short IKFeetPosY, short IKFeetPosZ, byte LegIKLegNr) {
  ...
  if ((byte)pgm_read_byte(&cTarsLength[LegIKLegNr])) {    // We allow mix of 3 and 4 DOF legs...
    ...
    //Always compensate TarsToGroundAngle1 when IKFeetPosY it goes below zero
    if (IKFeetPosY < 0) TarsToGroundAngle1 = TarsToGroundAngle1 - ((long)(IKFeetPosY*cTarsFactorC)/c1DEC);
    // TGA base, overall rule
    if (TarsToGroundAngle1 > 400) TGA_B_H3 = 200 + (TarsToGroundAngle1/2);
    else TGA_B_H3 = TarsToGroundAngle1;
    if (TarsToGroundAngle1 > 300) TGA_A_H4 = 240 + (TarsToGroundAngle1/5);
    else TGA_A_H4 = TarsToGroundAngle1;
    // Only compensate the TarsToGroundAngle1 when it exceed 30 deg (A, H4 PEP note)
    if (IKFeetPosY > 0) TarsToGroundAngle1 = TGA_A_H4;
    // linear transition between case H3 and H4 (from PEP: H4-K5*(H3-H4))
    else if (((IKFeetPosY <= 0) & (IKFeetPosY > -10))) TarsToGroundAngle1 = (TGA_A_H4 -(((long)IKFeetPosY*(TGA_B_H3-TGA_A_H4))/c1DEC));
    // IKFeetPosY <= -10, Only compensate TGA1 when it exceed 40 deg
  ...
  //IKFemurAngle
  #ifdef OPT_WALK_UPSIDE_DOWN
  if (g_fRobotUpsideDown) FemurAngle1[LegIKLegNr] = (long)(IKA14 + IKA24) * 180 / 3141 - 900 + CFEMURHORNOFFSET1(LegIKLegNr);//Inverted, up side down
  else FemurAngle1[LegIKLegNr] = -(long)(IKA14 + IKA24) * 180 / 3141 + 900 + CFEMURHORNOFFSET1(LegIKLegNr);//Normal
  #else
  ...
  #ifdef OPT_WALK_UPSIDE_DOWN
  if (g_fRobotUpsideDown)  TibiaAngle1[LegIKLegNr] = (1800-(long)AngleRad4*180/3141 + CTIBIAHORNOFFSET1(LegIKLegNr));//Full range tibia, wrong side (up side down)
  else  TibiaAngle1[LegIKLegNr] = -(1800-(long)AngleRad4*180/3141 + CTIBIAHORNOFFSET1(LegIKLegNr));//Full range tibia, right side (up side up)
  #else
  ...
  if(IKSW2 < ((word)((byte)pgm_read_byte(&cFemurLength[LegIKLegNr])+(byte)pgm_read_byte(&cTibiaLength[LegIKLegNr])-30)*c2DEC)) IKSolution = 1;
  else {
    if(IKSW2 < ((word)((byte)pgm_read_byte(&cFemurLength[LegIKLegNr])+(byte)pgm_read_byte(&cTibiaLength[LegIKLegNr]))*c2DEC))  IKSolutionWarning = 1;
    ...
    if (g_fDebugOutput && g_InControlState.fRobotOn) {
        ...
        if (LegIKLegNr == (CNT_LEGS-1)) DBGSerial.println();
    }
  #endif  
}
...
word GetLegsXZLength(void) {
  ...
  if (g_wLegsXZLength != 0xffff) return g_wLegsXZLength;
...
void AdjustLegPositions(word XZLength1) {
    ...
    if (XZLength1 > MAX_XZ_LEG_ADJUST) XZLength1 = MAX_XZ_LEG_ADJUST;
    if (XZLength1 < MIN_XZ_LEG_ADJUST) XZLength1 = MIN_XZ_LEG_ADJUST;
        
    // see if same length as when we came in
    if (XZLength1 == g_wLegsXZLength) return;
    ...
    #ifdef DEBUG
    if (g_fDebugOutput) DBGSerial.println("");
    #endif
...
void RotateLegInitAngles (int iDeltaAngle) {
  ...
  for (int LegIndex=0; LegIndex < CNT_LEGS; LegIndex++) {
      ...
      if ((short)pgm_read_word(&cCoxaAngle1[LegIndex]) > 0) g_InControlState.aCoxaInitAngle1[LegIndex] += iDeltaAngle;
      else if ((short)pgm_read_word(&cCoxaAngle1[LegIndex]) < 0)g_InControlState.aCoxaInitAngle1[LegIndex] -= iDeltaAngle;
      // Make sure we don't exceed some min/max angles.
      // Right now hard coded to +-70 degrees... Should probably load
      if (g_InControlState.aCoxaInitAngle1[LegIndex] > 700) g_InControlState.aCoxaInitAngle1[LegIndex] = 700;
      else if (g_InControlState.aCoxaInitAngle1[LegIndex] < -700) g_InControlState.aCoxaInitAngle1[LegIndex] = -700;
  }
  g_wLegsXZLength = 0xffff;
  #else
